...
COVERAGE_EXCLUDE=infrastructure|model|mocks|vendor|test|docs|main.go|config.go|client.go|engine.go|worker.go
...
dev-run:
	LOG_LEVEL=debug APP_HOST_NAME=localhost:8081 APP_PORT=:8081 DB_NAME=bookmark go run ./cmd/worker/main.go
